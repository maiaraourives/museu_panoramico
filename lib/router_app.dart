...
import 'package:museu_panoramico/views/ingresso/ingresso_view.dart';

import 'configs/routes/local_routes.dart';
import 'views/home/home_view.dart';
import 'views/panoramico/panoramico_view.dart';
...
class RouterApp {
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case LocalRoutes.INGRESSO:
        return _PageBuilder(
          child: const IngressoView(),
          settings: settings,
        );

      case LocalRoutes.PANORAMICO:
        return _PageBuilder(
          child: const PanoramicoView(),
          settings: settings,
        );
